...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
    ...
    //},
	{
		title: 'Tweets', path: '/tweets', icon: 'anchor', type: 'link', badgeType: 'primary',  active: true
	},
    {
      title: 'Listagem de usuários', path: '/usuario-lista', icon: 'anchor', type: 'link'
	},
	{
	  title: 'Cadastro de usuários', path: '/usuario-detalhe', icon: 'anchor', type: 'link'
	}
    ];
